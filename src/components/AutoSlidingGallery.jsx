  ...
  return (
    <>
      <div className="relative w-full h-[528px] overflow-hidden flex items-center justify-center" style={{ fontFamily: "'Merriweather', serif" }}>
        ...
        <div ref={containerRef} className="relative w-[1290px] h-[324px] overflow-hidden z-10">
          <motion.div className="flex absolute left-0 top-0" animate={controls}>
            {[...carouselData, ...carouselData].map((item, index) => (
              <motion.div
                key={`${item.id}-${index}`}
                className="relative w-[263px] h-[324px] rounded-lg overflow-hidden cursor-pointer flex-shrink-0 mx-[52.5px]"
      ...
      <div className="bg-[#141D31] pt-[138px] pb-[84px] pl-[122px] relative" style={{ fontFamily: "'Merriweather', serif" }}>
        ...
        <div className="relative w-full h-auto flex">
          ...
          <div
            className="absolute left-85 top-[-30px] w-[272px] h-[555px] bg-[#E1C9A1] blur-[50px]"
          ></div>
          <img
          ...
          <div className="ml-[71px] flex flex-col items-center relative z-10">
            <h2 className="text-[36px] font-bold text-center text-white">About Us</h2>
            <p className="mt-[66px] text-center text-white ml-[77px] mr-[122px]">
